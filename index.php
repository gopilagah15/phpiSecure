...
<div class="card-body">
<h5 class="card-title"><a href="/forum/phpiSecure/threadlist.php?catid='.$id.'">'.$name.'</a></h5>
<p class="card-text">'.substr($desc,0,50).'....</p>
<a href="/forum/phpiSecure/threadlist.php?catid='.$id.'"" class="btn btn-primary">View Threads</a>
